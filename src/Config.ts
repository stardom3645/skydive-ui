...
export const i18nMap = {
    en: {
        ...
        "switchPortMappingDescription": "Switch-to-host port relationships collected from the current LLDP topology.",
    ...
    ko: {
        ...
        "switchPortMappingDescription": "현재 LLDP 토폴로지에서 수집된 스위치와 호스트의 포트 연결 관계입니다.",
