...
export const i18nMap = {
    en: {
        ...
        "kubernetesRequestDescription": "Total resources requested (Request) so Pods can be guaranteed those resources when scheduled.\n\nThis value is different from current usage (Current).",
        "kubernetesLimitDescription": "Total maximum usable resources configured for Pods.\n\nContainers without a configured Limit are excluded from the total.\n\nTherefore, Limits can appear lower than Requests; this is normal Kubernetes behavior.",
        ...
        "kubernetesMemoryUnitDescription": "Kubernetes source units are converted to GiB and MiB for display.",
    ...
    ko: {
        ...
        "kubernetesRequestDescription": "Pod가 스케줄링 시 보장받기 위해 예약(Request)한 자원의 합계입니다.\n\n현재 사용량(Current)과는 다른 값입니다.",
        "kubernetesLimitDescription": "Pod에 설정된 최대 사용 가능 자원의 합계입니다.\n\nLimit이 설정되지 않은 컨테이너는 합계에 포함되지 않습니다.\n\n따라서 Requests보다 작게 표시될 수 있으며,\n이는 Kubernetes의 정상적인 동작입니다.",
        "kubernetesReservableDescription": "Allocatable에서 Requests를 뺀 값입니다. 새로운 Pod가 Request로 예약할 수 있는 남은 자원이며, 현재 사용량 기준 값은 아닙니다.",
        "kubernetesCpuUnitDescription": "1 Core = 1000m",
        "kubernetesMemoryUnitDescription": "Kubernetes 원본 단위를 GiB와 MiB로 변환하여 표시합니다.",
