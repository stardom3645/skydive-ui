...
export const i18nMap = {
    en: {
        ...
        "hostConnectedResourcesDescription": "VM, interface, address, and socket footprint.",
        "hostRecentSignals": "Recent signals",
        "hostRecentSignalsDescription": "Collection, agent, boot, and kernel timeline.",
    ...
    ko: {
        ...
        "hostConnectedResourcesDescription": "VM, 인터페이스, 주소, 소켓 관측 요약입니다.",
        "hostRecentSignals": "최근 신호",
        "hostRecentSignalsDescription": "수집, 에이전트, 부팅, 커널 타임라인입니다.",
