...
export const i18nMap = {
    en: {
        ...
        "kubernetesCollectionPolicyDescription": "Netdive collects the default Kubernetes resources below and excludes sensitive resource probes by default.",
    ...
    ko: {
        ...
        "kubernetesCollectionPolicyDescription": "Netdive는 아래 Kubernetes 리소스를 기본 수집 대상으로 사용하고, 민감 리소스 probe는 기본 제외합니다.",
