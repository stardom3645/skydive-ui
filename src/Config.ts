...
export const i18nMap = {
    en: {
        ...
        "hostConnectedVMsDescription": "User workload VMs connected to this host.",
        "hostSystemVMs": "System VMs",
        "hostSystemVMsDescription": "System VMs operating this host.",
        "hostVirtualRouters": "Virtual routers",
        "hostVirtualRoutersDescription": "Virtual routers related to this host.",
        "hostNetworkCountDescription": "Connected network objects and interfaces.",
    ...
    ko: {
        ...
        "hostConnectedVMsDescription": "이 호스트와 연결된 사용자 워크로드 VM입니다.",
        "hostSystemVMs": "시스템 VM",
        "hostSystemVMsDescription": "이 호스트를 운영하는 시스템 VM입니다.",
        "hostVirtualRouters": "가상 라우터",
        "hostVirtualRoutersDescription": "이 호스트와 연결된 가상 라우터입니다.",
        "hostNetworkCountDescription": "이 호스트와 연결된 네트워크 객체와 인터페이스입니다.",
        ...
        "hostListenPorts": "LISTEN 포트 수",
        "hostExternalConnections": "외부 연결 수",
