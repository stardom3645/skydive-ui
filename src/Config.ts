...
export const i18nMap = {
    en: {
        ...
        "kubernetesLimitDescription": "Limits\n\nTotal maximum resource values configured for containers.\n\nContainers without a configured Limit are excluded from the total, so Limits can appear lower than Requests.\n\nThis is normal Kubernetes behavior.",
    ...
    ko: {
        ...
        "kubernetesLimitDescription": "Limits\n\n컨테이너에 설정된 자원 최대값의 합계입니다.\n\nLimit이 설정되지 않은 컨테이너는 합계에 포함되지 않으므로 Requests보다 작게 표시될 수 있습니다.\n\n이는 Kubernetes의 정상적인 동작입니다.",
        ...
        "kubernetesAffectedServiceKpi": "서비스 영향",
