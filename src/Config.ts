...
export const i18nMap = {
    en: {
        ...
        "infrastructurePanelDescription": "Return to the default network, host, and VM topology view.",
        "infrastructurePanelHosts": "Hosts",
        "infrastructurePanelHostsDescription": "Physical and virtual host objects",
        "infrastructurePanelNetwork": "Network",
        "infrastructurePanelNetworkDescription": "NIC, bond, bridge, VLAN, and switch layers",
        "infrastructurePanelVirtual": "Virtualization",
        "infrastructurePanelVirtualDescription": "User VM, system VM, router, and VM network objects",
    ...
    ko: {
        ...
        "infrastructurePanelDescription": "기본 네트워크, 호스트, VM 토폴로지 화면으로 돌아갑니다.",
        "infrastructurePanelHosts": "호스트",
        "infrastructurePanelHostsDescription": "물리/가상 호스트 객체",
        "infrastructurePanelNetwork": "네트워크",
        "infrastructurePanelNetworkDescription": "NIC, Bond, 브리지, VLAN, 스위치 계층",
        "infrastructurePanelVirtual": "가상화",
        "infrastructurePanelVirtualDescription": "사용자 VM, 시스템 VM, 라우터, VM 네트워크 객체",
        "kubernetesCollectionMenu": "Kubernetes",
