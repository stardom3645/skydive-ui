...
export const i18nMap = {
    en: {
        ...
        "hostOverviewTab": "Overview",
        "hostNetworkConnectionsTab": "Switch connections",
        ...
        "switchPortMappingHost": "Connected host",
        "switchPortMappingNic": "Host NIC",
        "switchPortMappingState": "Connection state",
        "switchPortMappingSource": "Collection method",
        "switchPortMappingConnected": "Connected",
        "switchPortMappingDisconnected": "Disconnected",
        "switchPortMappingUnknown": "Unknown",
        "switchPortMappingAutomatic": "Automatic",
        "switchPortMappingManual": "Manual",
        "switchPortMappingMismatch": "Mismatch",
        "switchPortMappingUncollected": "Not collected",
        "manualPortMappingManage": "Manage manual mappings",
        "manualPortMappingMenuAdd": "Add manual mapping",
        "manualPortMappingMenuList": "Manual mapping list",
        "manualPortMappingTitle": "Manual switch port mapping",
        "manualPortMappingGuidance": "Only switch ports without an automatic LLDP connection can be mapped manually. Manual mappings do not verify physical cabling; connection status is based on the host NIC.",
        "manualPortMappingSelectPort": "Enter a switch port name",
        "manualPortMappingSelectNic": "Select a host and NIC",
        "manualPortMappingAvailableNics": "Unmapped NICs (selectable)",
        "manualPortMappingUnavailableNics": "Already connected (unavailable)",
        "manualPortMappingNoAvailableNic": "No unmapped host NICs are available.",
        "manualPortMappingNoNicSearchResults": "No host NIC matches this search.",
        "manualPortMappingNicUp": "UP",
        "manualPortMappingNicDown": "DOWN",
        "manualPortMappingNicDownHelp": "Verify the physical cable and switch port state.",
        "manualPortMappingNicUnknown": "State unavailable",
        "manualPortMappingNicAutoInUse": "LLDP automatic connection",
        "manualPortMappingNicManualInUse": "Manual mapping",
        "manualPortMappingSelectionRequired": "Select both a switch port and a host NIC.",
		"manualPortMappingPortRequired": "Enter a switch port name.",
		"manualPortMappingAutomaticConflict": "This switch port has an automatic LLDP connection and cannot be mapped manually.",
		"manualPortMappingNICAutomaticConflict": "This host NIC already has an automatic LLDP connection and cannot be mapped manually.",
		"manualPortMappingNICDuplicate": "This host NIC already has an active manual mapping.",
        ...
        "manualPortMappingCancelEdit": "Cancel",
        ...
        "hostSwitchPortBondInterface": "Bond interface",
        "hostSwitchPortBondShort": "Bond",
        "hostSwitchPortConnectedSwitch": "Connected switch",
        "hostSwitchPortNoBond": "None",
        "switchPortConnectedNodes": "Connected NICs",
        "switchPortPortId": "Port ID",
        "switchPortPortIdType": "Port ID type",
        "switchPortDescription": "Port description",
        "switchPortDetails": "Port information",
        "switchPortPvid": "Default VLAN (PVID)",
        "switchPortManagementVlan": "Management VLAN",
        "switchPortVlans": "VLANs",
        "switchPortLinkAggregation": "Link aggregation",
        "switchPortLinkAggregationEnabled": "Active",
        "switchPortLinkAggregationDisabled": "Inactive",
        "switchPortConnectionInfo": "Connection information",
        "switchPortConnectionAutomatic": "Automatic (LLDP)",
        "switchPortConnectionManual": "Manual mapping",
        ...
        "previousSelectionNamedTooltip": "Previous selection: {name}",
        "nextSelectionTooltip": "Go to next selection",
        "nextSelectionNamedTooltip": "Next selection: {name}",
        ...
        "infrastructureNetworkObjects": "Network",
        ...
        "infrastructureSummaryStatus": "Summary",
        "infrastructureAgentRestartTitle": "Restart infrastructure collection",
        "infrastructureAgentRestartAction": "Restart collection",
        "infrastructureAgentRestartWarning": "This restarts the Netdive Agent and may temporarily interrupt infrastructure data collection.",
        "infrastructureAgentRestartScope": "Target scope",
        "infrastructureAgentRestartAllHosts": "All hosts",
        "infrastructureAgentRestartSpecificHosts": "Specific hosts",
        "infrastructureAgentRestartSelectHosts": "Select hosts",
        "infrastructureAgentRestartExecute": "Restart",
        "infrastructureAgentRestartRunning": "Running",
        "infrastructureAgentRestartLastTime": "Last restart",
        "infrastructureAgentRestartTargetSummary": "Total / Success / Failed",
        "infrastructureAgentRestartTotal": "Total",
        "infrastructureAgentRestartSucceeded": "Success",
        "infrastructureAgentRestartFailedCount": "Failed",
        "infrastructureAgentRestartNever": "No history",
        "infrastructureAgentRestartResult_never": "No history",
        "infrastructureAgentRestartResult_running": "Running",
        "infrastructureAgentRestartResult_success": "Success",
        "infrastructureAgentRestartResult_partial": "Partial failure",
        "infrastructureAgentRestartResult_failed": "Failed",
        "infrastructureAgentRestartSuccess": "Infrastructure collection restarted",
        "infrastructureAgentRestartPartial": "Infrastructure collection restart partially failed",
        "infrastructureAgentRestartFailed": "Infrastructure collection restart failed",
        "infrastructureAgentRestartHostsSucceeded": "hosts succeeded",
        "infrastructureAgentRestartUnknownFailure": "Unknown failure",
        "all": "All",
    ...
    ko: {
        ...
        "hostBasicInfo": "기본 정보",
        "hostOverviewTab": "개요",
        "hostNetworkConnectionsTab": "스위치 정보",
        ...
        "switchPortMappingHost": "연결 호스트",
        "switchPortMappingNic": "호스트 NIC",
        "switchPortMappingState": "연결 상태",
        "switchPortMappingSource": "수집 방식",
        "switchPortMappingConnected": "연결됨",
        "switchPortMappingDisconnected": "연결 실패",
        "switchPortMappingUnknown": "확인 불가",
        "switchPortMappingAutomatic": "자동",
        "switchPortMappingManual": "수동",
        "switchPortMappingMismatch": "불일치",
        "switchPortMappingUncollected": "수집되지 않음",
        "manualPortMappingManage": "수동 매핑 관리",
        "manualPortMappingMenuAdd": "수동 매핑 추가",
        "manualPortMappingMenuList": "수동 매핑 목록",
        "manualPortMappingTitle": "스위치 포트 수동 매핑",
        "manualPortMappingGuidance": "LLDP 자동 연결이 없는 포트만 수동 등록할 수 있습니다. 실제 배선은 검증하지 않으며, 연결 상태는 호스트 NIC 기준입니다.",
        "manualPortMappingSelectPort": "스위치 포트명을 입력하세요",
        "manualPortMappingSelectNic": "호스트와 NIC를 선택하세요",
        "manualPortMappingAvailableNics": "미매핑 NIC (선택 가능)",
        "manualPortMappingUnavailableNics": "연결됨 (선택 불가)",
        "manualPortMappingNoAvailableNic": "수동 매핑 가능한 미연결 호스트 NIC가 없습니다.",
        "manualPortMappingNoNicSearchResults": "검색 조건과 일치하는 호스트 NIC가 없습니다.",
        "manualPortMappingNicUp": "UP",
        "manualPortMappingNicDown": "DOWN",
        "manualPortMappingNicDownHelp": "물리 케이블과 스위치 포트 상태를 확인하세요.",
        "manualPortMappingNicUnknown": "상태 확인 불가",
        "manualPortMappingNicAutoInUse": "LLDP 자동 연결",
        "manualPortMappingNicManualInUse": "수동 매핑됨",
        "manualPortMappingSelectionRequired": "스위치 포트와 호스트 NIC를 모두 선택하세요.",
		"manualPortMappingPortRequired": "스위치 포트명을 입력하세요.",
		"manualPortMappingAutomaticConflict": "해당 스위치 포트는 LLDP 자동 연결이 존재하여 수동 등록할 수 없습니다.",
		"manualPortMappingNICAutomaticConflict": "해당 호스트 NIC는 LLDP 자동 연결이 존재하여 수동 등록할 수 없습니다.",
		"manualPortMappingNICDuplicate": "해당 호스트 NIC에 활성 수동 매핑이 이미 존재합니다.",
        ...
        "manualPortMappingCancelEdit": "취소",
        ...
        "hostSwitchPortBondInterface": "본딩 인터페이스",
        "hostSwitchPortBondShort": "본딩",
        "hostSwitchPortConnectedSwitch": "연결 스위치",
        "hostSwitchPortNoBond": "없음",
        "switchPortConnectedNodes": "연결 NIC",
        "switchPortPortId": "포트 ID",
        "switchPortPortIdType": "포트 ID 유형",
        "switchPortDescription": "포트 설명",
        "switchPortDetails": "포트 정보",
        "switchPortPvid": "기본 VLAN(PVID)",
        "switchPortManagementVlan": "관리 VLAN",
        "switchPortVlans": "VLAN 목록",
        "switchPortLinkAggregation": "링크 집성",
        "switchPortLinkAggregationEnabled": "활성",
        "switchPortLinkAggregationDisabled": "비활성",
        "switchPortConnectionInfo": "연결 정보",
        "switchPortConnectionAutomatic": "자동(LLDP)",
        "switchPortConnectionManual": "수동 매핑",
        ...
        "previousSelectionNamedTooltip": "이전 선택: {name}",
        "nextSelectionTooltip": "다음 선택으로 이동",
        "nextSelectionNamedTooltip": "다음 선택: {name}",
        "openConsole": "콘솔 열기",
        "setting": "설정",
        "refresh": "새로고침",
        "loading": "불러오는 중",
        ...
        "infrastructureNetworkObjects": "네트워크",
        ...
        "infrastructureSummaryStatus": "요약 현황",
        "infrastructureAgentRestartTitle": "인프라스트럭처 수집 재시작",
        "infrastructureAgentRestartAction": "수집 재시작",
        "infrastructureAgentRestartWarning": "Netdive Agent를 재시작하며, 일시적으로 인프라스트럭처 정보 수집이 중단될 수 있습니다.",
        "infrastructureAgentRestartScope": "대상 범위",
        "infrastructureAgentRestartAllHosts": "전체 호스트",
        "infrastructureAgentRestartSpecificHosts": "특정 호스트",
        "infrastructureAgentRestartSelectHosts": "호스트를 선택하세요",
        "infrastructureAgentRestartExecute": "재시작",
        "infrastructureAgentRestartRunning": "실행 중",
        "infrastructureAgentRestartLastTime": "최근 재시작",
        "infrastructureAgentRestartTargetSummary": "전체 / 성공 / 실패",
        "infrastructureAgentRestartTotal": "전체",
        "infrastructureAgentRestartSucceeded": "성공",
        "infrastructureAgentRestartFailedCount": "실패",
        "infrastructureAgentRestartNever": "실행 이력 없음",
        "infrastructureAgentRestartResult_never": "실행 이력 없음",
        "infrastructureAgentRestartResult_running": "실행 중",
        "infrastructureAgentRestartResult_success": "성공",
        "infrastructureAgentRestartResult_partial": "일부 실패",
        "infrastructureAgentRestartResult_failed": "실패",
        "infrastructureAgentRestartSuccess": "인프라스트럭처 수집 재시작 완료",
        "infrastructureAgentRestartPartial": "인프라스트럭처 수집 재시작 일부 실패",
        "infrastructureAgentRestartFailed": "인프라스트럭처 수집 재시작 실패",
        "infrastructureAgentRestartHostsSucceeded": "개 호스트 성공",
        "infrastructureAgentRestartUnknownFailure": "확인되지 않은 실패",
        "all": "전체",
        "kubernetesCollectionMenu": "Kubernetes",
