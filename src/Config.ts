...
export const i18nMap = {
    en: {
        ...
        "aboutPanelDescription": "Product and version information.",
        "version": "Version",
        ...
        "help": "Help",
        "helpInfraTitle": "Infrastructure topology",
        "helpInfraDescription": "Visualizes relationships between hosts, NICs, bridges, VLANs, routers, and virtual machines.",
        "helpInfraPointLayers": "Use the left layer menu to understand where each network object belongs.",
        "helpInfraPointSearch": "Search by host, VM, interface, or display name from the top search box.",
        "helpInfraPointDetail": "Select a node to inspect properties and available actions in the right detail panel.",
    ...
    ko: {
        ...
        "aboutPanelDescription": "제품 및 버전 정보입니다.",
        "version": "버전",
        ...
        "help": "도움말",
        "helpInfraTitle": "인프라스트럭처 토폴로지",
        "helpInfraDescription": "호스트, NIC, 브리지, VLAN, 라우터, 가상머신의 연결 관계를 시각화합니다.",
        "helpInfraPointLayers": "좌측 계층 메뉴에서 네트워크 객체가 어느 계층에 속하는지 확인합니다.",
        "helpInfraPointSearch": "상단 검색창에서 호스트, VM, 인터페이스, 표시 이름을 검색합니다.",
        "helpInfraPointDetail": "노드를 선택하면 우측 상세 패널에서 속성과 기능을 확인합니다.",
